...
def main():
    ...
    with sync_playwright() as p:
        ...
        check('portfolio synthesis recurrence is explicitly non-edge',page.locator('#portfolioSynthesis').count()==1 and all(x['scientific_edge'] is False for x in data['syntheses']))
